<?php
 ...
 <html lang="en" dir="ltr">
   ...
   <!-- Open CSS -->
     ...
     <div class="sidebar">
       <div class="status">
         ...
         <div class="btn-group">
            ...
            <button class="btnn" onClick="window.location='tampil_akun.php';"><img src="../../Icon/agen.png" width=32 height=32><br><b>Kelola Agen</b></button>
     ...
     <div class="body">
     <center><h3>Kelola Agen</h3></center>
       <div class="pencarian">
         <form method="get">
       ...
       <a class="btn-add" href="register_agen.php">Register Agen</a> <br><br>
       <table border="1" cellpadding=4 cellspacing=0 width=95% align=center>
         ...
         <?php
            ...
            if (isset($_GET['cari'])) {
              $key = $_GET['key'];
              $cari = "SELECT * FROM tb_akun WHERE username LIKE '%$key%'";
            }else {
              $cari = "SELECT * FROM tb_akun";
            }
            $row = 5;
            ...
            $tampil2 = mysqli_query($koneksi,"SELECT * FROM tb_akun LIMIT $mulai,$row");
            $no = $mulai + 1;
            if ($result == 0) {
              ...
              while ($data = mysqli_fetch_assoc($sql)) {
                echo "<tr>
                          ...
                          <td>".$data['password']."</td>
                          <td>".$data['status']."</td>";?>
                          <?php if ($data['status']=="owner") {
                            echo "<td></td>";
                          }else {
                            echo "<td><a class='btn-link' href='ubah_stok.php?id=".$data['id_akun']."''><img src='../../Icon/edit.png' width=32 height=32></a>
                                      <a href='hapus_stok.php?id=".$data['id_akun']."'";?>
                                      onClick="return confirm('Mau Hapus data Stok ini ?')"</a><img src="../../Icon/hapus.png" width="32" height="32">
                        <?php } ?>
                </tr><?php
              }
            }
